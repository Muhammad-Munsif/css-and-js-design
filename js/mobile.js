    ...
    cloneFormToMobile() {
        ...
        formClone.addEventListener('submit', (e) => {
            ...
            if (typeof createElement === 'function') {
                ...
                document.getElementById('textColor').value = formClone.querySelector('#textColor').value;
                document.getElementById('bgColor').value = formClone.querySelector('#bgColor').value;
                document.getElementById('addBorder').checked = formClone.querySelector('#addBorder').checked;
        ...
        elementBtns.forEach(btn => {
            btn.addEventListener('click', (e) => {
                const elementType = e.target.closest('.element-btn').classList[1].replace('-btn', '');
                formClone.querySelector('#elementSelect').value = elementType;
                
                // Highlight selected button
                elementBtns.forEach(b => b.classList.remove('selected', 'ring-2', 'ring-blue-500'));
                e.target.closest('.element-btn').classList.add('selected', 'ring-2', 'ring-blue-500');
            });
        });
    },
